...
export default function Footer() {
  ...
  const footerLinks = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Customer Review", href: "/reviews" },
  ...
  return (
    <footer className="relative mt-16 bg-gradient-to-t from-black via-zinc-900/50 to-transparent border-t-2 border-white/10 z-20">
      {/* Gradient overlay */}
